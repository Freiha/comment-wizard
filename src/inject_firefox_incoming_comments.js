...
const bannerImageUrlDiv = document.getElementById("bannerImageDivUrl");
if (bannerImageUrlDiv) {
  const imageUrls = JSON.parse(bannerImageDivUrl.innerText);
  BACKGROUND_IMAGE_URL = imageUrls.backgroundImage;
  AD_IMAGE_URL = imageUrls.adImage;
}
