function buildAndAppendCommentHTML(u_cbox_list, comment, comic, episode, isReply) {
    ...
    if (isReply) {
        ...
        anchor_to_comment.setAttribute("href", episode.url + "&comment_no=" + commentNo);
    ...
    if (!isReply && replyCount > 0) {
        ...
        u_cbox_btn_reply.setAttribute("class", "u_cbox_btn_reply _btnReply N=a:myc.reply,g:en_en");
        ...
        applyGetRepliesEventListener(u_cbox_btn_reply, u_cbox_comment, comic, episode, commentNo, objectId);
    ...
    if (didLike)
        u_cbox_btn_recomm.setAttribute("class", "u_cbox_btn_recomm _btnLike N=a:myc.rpup,g:en_en u_cbox_btn_recomm_on");
    else
        u_cbox_btn_recomm.setAttribute("class", "u_cbox_btn_recomm  _btnLike");
    ...
    applyLikeDislikeEventListener(u_cbox_btn_recomm, u_cbox_cnt_recomm, commentNo, objectId, "SYMPATHY");

    const u_cbox_btn_unrecomm = document.createElement('a');
    u_cbox_btn_unrecomm.setAttribute("href", URL_SUFFIX);
    if (didDislike)
        u_cbox_btn_unrecomm.setAttribute("class", "u_cbox_btn_unrecomm _btnDislike N=a:myc.rpdown,g:en_en u_cbox_btn_unrecomm_on");
    else
        u_cbox_btn_unrecomm.setAttribute("class", "u_cbox_btn_unrecomm  _btnDislike");
    ...
    applyLikeDislikeEventListener(u_cbox_btn_unrecomm, u_cbox_cnt_unrecomm, commentNo, objectId, "ANTIPATHY");
}

function buildBasicHTML() {

    const my_comments_wrap = document.getElementsByClassName("my_comments_wrap")[0];

    let u_cbox_list = document.getElementsByClassName("u_cbox_list _commentList")[0];
